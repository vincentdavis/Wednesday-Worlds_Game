  ...
  export default {
    ...
    onButtonUp(key) {
      ...
      animate() {
        ...
        this.box.velocity.z = 0;
        if (this.keys.a.pressed) this.box.velocity.x = -0.05;
        else if (this.keys.d.pressed) this.box.velocity.x = 0.05;
  
        if (this.keys.s.pressed) this.box.velocity.z = 0.05;
        else if (this.keys.w.pressed) this.box.velocity.z = -0.05;
  
        this.box.position.x += this.box.velocity.x;
        this.box.position.z += this.box.velocity.z;
